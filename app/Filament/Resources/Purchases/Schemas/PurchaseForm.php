                ...
                Section::make('General Information')
                    ->schema([
                        ...
                        TextInput::make('invoice_number')
                            ...
                            ->default(fn() => 'PRC-' . strtoupper(uniqid()))
                            ->required()
                            ->disabled()
                            ->dehydrated()
                ...
                Section::make('Supplier Information')
                    ->schema([
                        ...
                        Placeholder::make('email')
                            ->label('Email Address')
                            ->content(fn(Get $get) => $get('supplier_id') ? Supplier::find($get('supplier_id'))?->name : '-'),
                        Placeholder::make('phone')
                            ->label('Phone Number')
                            ->content(fn(Get $get) => $get('supplier_id') ? Supplier::find($get('supplier_id'))?->phone : '-'),
                        Placeholder::make('address')
                            ->label('Address')
                            ->columnSpanFull()
                            ->content(fn(Get $get) => $get('supplier_id') ? Supplier::find($get('supplier_id'))?->address : '-'),
                    ])
                    ->columns(2)
                    ->columnSpanFull(),
                Group::make()
